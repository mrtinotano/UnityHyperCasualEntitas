...
public partial class Contexts : Entitas.IContexts {
    ...
    public SoundContext sound { get; set; }
    public TimeContext time { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { config, game, gui, input, sound, time }; } }
